...
# user based executable path
PATH=$HOME/usr/bin:$HOME/.rvm/bin:$HOME/.pyenv/bin:$HOME/usr/local/HDF5/bin:$HOME/usr/local/cmake/bin:$PATH
# add julia path
PATH=$HOME/usr/local/julia/bin:$HOME/.playground/bin:$PATH
